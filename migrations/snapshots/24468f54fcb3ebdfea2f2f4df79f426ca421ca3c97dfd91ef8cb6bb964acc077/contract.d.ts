...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Configuracion: {
      readonly id: CodecTypes['pg/text@1']['output'];
      readonly requerir_llave_navegador: CodecTypes['pg/bool@1']['output'];
      readonly requerir_llave_dispositivo: CodecTypes['pg/bool@1']['output'];
      readonly hora_limite_tardanza: CodecTypes['pg/text@1']['output'];
      readonly requerir_misma_red: CodecTypes['pg/bool@1']['output'];
    };
    readonly Usuario: {
      readonly id: CodecTypes['pg/text@1']['output'];
      readonly usuario: CodecTypes['pg/text@1']['output'];
      readonly nombre_completo: CodecTypes['pg/text@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Configuracion: {
      readonly id: CodecTypes['pg/text@1']['input'];
      readonly requerir_llave_navegador: CodecTypes['pg/bool@1']['input'];
      readonly requerir_llave_dispositivo: CodecTypes['pg/bool@1']['input'];
      readonly hora_limite_tardanza: CodecTypes['pg/text@1']['input'];
      readonly requerir_misma_red: CodecTypes['pg/bool@1']['input'];
    };
    readonly Usuario: {
      readonly id: CodecTypes['pg/text@1']['input'];
      readonly usuario: CodecTypes['pg/text@1']['input'];
      readonly nombre_completo: CodecTypes['pg/text@1']['input'];
              ...
              columns: {
                readonly id: {
                  ...
                  readonly default: {
                    ...
                    readonly value: DefaultLiteralValue<'pg/text@1', 'singleton'>;
                  };
                };
                readonly requerir_llave_navegador: {
                ...
                readonly requerir_llave_dispositivo: {
                  readonly nativeType: 'bool';
                  readonly codecId: 'pg/bool@1';
                  readonly nullable: false;
                  readonly default: {
        ...
        readonly models: {
          ...
          readonly Configuracion: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly requerir_llave_navegador: { readonly column: 'requerir_llave_navegador' };
                readonly requerir_llave_dispositivo: {
                  readonly column: 'requerir_llave_dispositivo';
                };
                readonly hora_limite_tardanza: { readonly column: 'hora_limite_tardanza' };
                readonly requerir_misma_red: { readonly column: 'requerir_misma_red' };
              };
            };
          };
          readonly Usuario: {
